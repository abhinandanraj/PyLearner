## How to Contribute Questions and Solutions
 
### If you'd like to add random questions, such as interview questions, follow these steps:

### 1.Name the Challenge:
Use a consistent naming convention like Challenge 1, Challenge 2, etc., and add it in this README.md file.

### 2.Describe the Question:
Write the question clearly in the README.md file. Provide all necessary details to understand the problem.

### 3.Provide the Solution:
Add your solution as a Python file in the same repository and Add Solution Link below the problem.<br>
